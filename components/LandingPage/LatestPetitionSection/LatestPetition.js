...
const LatestPetition = () => {
    ...
    const latestPetition = [
        {
            ...
            petitionTitle: "LIVE BROADCAST THE NIGERIA PRESIDENTIAL ECTION PETITION TRIBUNAL-PEPT",
            petitionParagraph: "Unleash the power of petitions with ease. Create, manage, and romote your causes effortlessly... ",
  ...
  return (
    <div className='latest-petition-container'>
        ...
        {latestPetition.map((petition, idx) => {
            ...
            return (
                <div className='petition' key={idx}>
                    ...
                    <p> {petition.petitionParagraph} <a href='{}' target='__blank' >Read More</a>
                    </p>
